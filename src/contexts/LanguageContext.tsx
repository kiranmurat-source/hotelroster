...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "reports.subtitle": "Tarih aralığına göre vardiya ve talep raporlarını görüntüleyin",
    "reports.startDate": "Başlangıç Tarihi",
    "reports.endDate": "Bitiş Tarihi",
    "reports.pickDate": "Tarih seçin",
    "reports.department": "Departman",
    "reports.allDepartments": "Tüm Departmanlar",
    "reports.totalShifts": "Toplam Vardiya",
    "reports.extraHoursApproved": "Onaylı / Toplam Fazla Mesai",
    "reports.extraStaffApproved": "Onaylı / Toplam Ek Personel",
    "reports.pendingRequests": "Bekleyen Talepler",
    "reports.rosterTab": "Vardiya",
    "reports.extraHoursTab": "Fazla Mesai",
    "reports.extraStaffTab": "Ek Personel",
    "reports.exportCSV": "CSV İndir",
    "reports.noData": "Seçilen tarih aralığında veri bulunamadı",
    "reports.date": "Tarih",
    "reports.staffName": "Personel",
    "reports.shift": "Vardiya",
    "reports.hours": "Saat",
    "reports.reason": "Sebep",
    "reports.status": "Durum",
    "reports.staffNeeded": "Gereken Personel",
    "reports.requestedBy": "Talep Eden",
  ...
  en: {
    ...
    "reports.subtitle": "View roster and request reports by date range",
    ...
    "reports.totalShifts": "Total Shifts",
    "reports.extraHoursApproved": "Approved / Total Extra Hours",
    "reports.extraStaffApproved": "Approved / Total Extra Staff",
    "reports.pendingRequests": "Pending Requests",
    "reports.rosterTab": "Roster",
    "reports.extraHoursTab": "Extra Hours",
    "reports.extraStaffTab": "Extra Staff",
    "reports.exportCSV": "Export CSV",
    "reports.noData": "No data found for the selected date range",
    "reports.date": "Date",
    "reports.staffName": "Staff",
    "reports.shift": "Shift",
    "reports.hours": "Hours",
    "reports.reason": "Reason",
    "reports.status": "Status",
    "reports.staffNeeded": "Staff Needed",
    "reports.requestedBy": "Requested By",
    ...
    // Permissions
    "permissions.cannotApprove": "You don't have permission to approve requests",
    "permissions.noRequests": "No requests to display",
    "permissions.accessDenied": "Access denied",

    // Recognition
    "recognition.title": "Recognition",
    "recognition.subtitle": "Send kudos to your team members",
    "recognition.sendKudos": "Send Kudos",
    "recognition.recipient": "Recipient",
    "recognition.selectRecipient": "Select a person",
    "recognition.category": "Category",
    "recognition.selectCategory": "Select category",
    "recognition.message": "Message",
    "recognition.messagePlaceholder": "Write your appreciation...",
    "recognition.send": "Send",
    "recognition.sent": "Kudos sent!",
    "recognition.cantSelfKudos": "You can't send kudos to yourself",
    "recognition.activityFeed": "Activity Feed",
    "recognition.noKudos": "No kudos yet",
    "recognition.leaderboard": "This Month's Leaders",
    "recognition.noPoints": "No points this month yet",
    "recognition.myBadges": "My Badges",
    "recognition.noBadges": "No badges found",
  },
};
