...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "leave.subtitle": "Personel izin taleplerini oluşturun ve yönetin",
    "leave.addNew": "Yeni İzin Ekle",
    "leave.staff": "Personel",
    "leave.selectStaff": "Personel seçin",
    "leave.type": "İzin Tipi",
    "leave.startDate": "Başlangıç Tarihi",
    "leave.endDate": "Bitiş Tarihi",
    "leave.days": "Gün Sayısı",
    "leave.notes": "Notlar",
    "leave.notesPlaceholder": "İzinle ilgili not ekleyin...",
    "leave.save": "İzin Kaydet",
    "leave.saved": "İzin kaydedildi",
    "leave.deleted": "İzin silindi",
    "leave.fillAll": "Lütfen tüm zorunlu alanları doldurun",
    "leave.allRequests": "İzin Talepleri",
    "leave.allTypes": "Tüm Tipler",
    "leave.allMonths": "Tüm Aylar",
    "leave.staffCol": "Personel",
    "leave.deptCol": "Departman",
    "leave.typeCol": "İzin Tipi",
    "leave.startCol": "Başlangıç",
    "leave.endCol": "Bitiş",
    "leave.daysCol": "Gün",
    "leave.statusCol": "Durum",
    "leave.notesCol": "Notlar",
    "leave.noRequests": "Görüntülenecek izin talebi yok",
    "leave.publicHolidays": "Resmi Tatiller",
    "leave.applyAll": "Uygula",
    "leave.applyHolidayTitle": "Tüm Personele Uygula",
    "leave.selectDeptsLabel": "Departman seçin:",
    "leave.selectDepts": "En az bir departman seçin",
    "leave.noDepts": "Departman bulunamadı",
    "leave.cancel": "İptal",
  ...
  en: {
    ...
    "leave.subtitle": "Create and manage staff leave requests",
    "leave.addNew": "Add New Leave",
    "leave.staff": "Staff",
    "leave.selectStaff": "Select staff",
    "leave.type": "Leave Type",
    "leave.startDate": "Start Date",
    "leave.endDate": "End Date",
    "leave.days": "Days Requested",
    "leave.notes": "Notes",
    "leave.notesPlaceholder": "Add notes about the leave...",
    "leave.save": "Save Leave",
    "leave.saved": "Leave saved",
    "leave.deleted": "Leave deleted",
    "leave.fillAll": "Please fill in all required fields",
    "leave.allRequests": "Leave Requests",
    "leave.allTypes": "All Types",
    "leave.allMonths": "All Months",
    "leave.staffCol": "Staff",
    "leave.deptCol": "Department",
    "leave.typeCol": "Leave Type",
    "leave.startCol": "Start",
    "leave.endCol": "End",
    "leave.daysCol": "Days",
    "leave.statusCol": "Status",
    "leave.notesCol": "Notes",
    "leave.noRequests": "No leave requests to display",
    "leave.publicHolidays": "Public Holidays",
    "leave.applyAll": "Apply",
    "leave.applyHolidayTitle": "Apply to All Staff",
    "leave.selectDeptsLabel": "Select departments:",
    "leave.selectDepts": "Select at least one department",
    "leave.noDepts": "No departments found",
    "leave.cancel": "Cancel",
